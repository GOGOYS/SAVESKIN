...
//		return queryString;
	...
	public String queryString5() {
		...
		return String.format(queryString, RecallAPIConfig.SERVICE_KEY,1,5,"0206");
//		return queryString;
	...
	public RecallReturn getRecallList5(String queryString5) {
		...
		try {
			log.debug(queryString5);

			restURI = new URI(queryString5);
